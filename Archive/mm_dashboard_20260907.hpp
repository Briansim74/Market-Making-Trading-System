    ...
    Component Dashboard(){
        ...
        return ftxui::Renderer([&]{
            ...
            auto signals = vbox({
                ...
                row_text("Toxicity", format("{:<15.10f}", snap.signals.tox)),
                ...
                row_text("Toxicity Signal Quality", format("{:<15.2f}", snap.signals.toxicity_signal_quality)),
                row_text("", "")
            });
    ...
    json snapshot_to_json(const Snapshot& snap){
        return {
            ...
            {"signals", {
                ...
                {"toxicity_signal_quality", snap.signals.toxicity_signal_quality},
            }},
            {"quotes", {

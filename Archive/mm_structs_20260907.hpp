...
struct Toxicity {
    double tox = 0.0;
    double k_spread = 500.0; // 1 + kspread * 0.00020 = 1.10 (10%)
    double k_order_size = 22293000.0; // assuming signed_markout == 5e-9, e^-k(5e−9) = 0.90 (10%)
    int64_t horizon_ms;
    double pred = 0.0;
};
...
struct Signal {
    ...
    double toxicity_signal_quality;
